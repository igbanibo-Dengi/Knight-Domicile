...
const propertyData: PropertyData = {
    ...
    description: "Charming 2 bedroom, 1 bathroom home in the heart of Tulia, TX. This cozy abode offers a perfect opportunity for first-time homebuyers, offering a comfortable and affordable living space with plenty of room for outdoor activities.",
    propertyInfo: {
        squareFeet: "912 sqft",
